...
export default function Team() {
  return (
    ...
    >
      ...
      <p className="text-sm md:text-xl font-light text-akkar-black  text-center md:mb-16">This website application made with such great team that the creativity 
is his priority 
 </p>
