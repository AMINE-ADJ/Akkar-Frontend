...
export default function card(props) {  //ki ndiro l contenu w YB3TOLI TSAWRHOM W NSGMO DESCRIPTION  npassi data bl props
    return (
        ...
        <div className=" h-[50px] w-[50px] md:h-[140px] md:w-[140px] rounded-[50%] md:mt-[60px] mt-[30px] ">
            <img src={amine} className="w-[100%] h-[100%] rounded-[50%] object-cover"></img>
        </div>
        <p className="md:text-2xl text-akkar-orange md:mt-[35px] font-medium text-center text-lg ">{props.name}</p>
        <p className=" text-sm text-center text-akkar-brown-second mt-[2px] md:mt-[20px] md:text-xl">{props.description}</p>
